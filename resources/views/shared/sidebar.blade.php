<!-- Link do Panelu -->
{{--<a href="{{ route('home.mainPage') }}" class="flex items-center p-2 hover:bg-gray-200 rounded transition duration-150 ease-in-out">--}}
...
<nav class="space-y-2">
    ...
    {{--    <a href="{{ route('me.games.list') }}" class="block p-2 hover:bg-gray-200 rounded transition duration-150 ease-in-out">Gry</a>--}}
</nav>
